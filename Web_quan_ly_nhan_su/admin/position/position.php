        ...
        <div class="display-body">
            <div class="search">
                ...
                <div class="button-add">
                    <?php if(checkPrivilege('add_position.php')) { ?>
                    <button id="openModal">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <div class="modal-content-form">
                                <form action="add_position.php" method="post" id="myForm">
                                    <div class="flex-container">
                                        <label for="fullname">Chức vụ:</label><br>
                                        <input type="text" id="fullname" name="fullname" placeholder="Chức vụ" >
                                        <div class="error-message" id="fullnameError">Vui lòng nhập chức vụ.</div>
                                    </div>
                                    <div class="flex-container">
                                        <label for="Salesmilestone">Cột mốc:</label><br>
                                        <input type="text" class="amount" id="Salesmilestone" name="Salesmilestone" placeholder="Cột mốc" >
                                        <div class="error-message" id="SalesmilestoneError">Vui lòng nhập mã cấp trên.</div>
                                    </div>
                                    <div class="flex-container">
                                        <label for="completiontime">Lương chấm công:</label><br>
                                        <input type="text" class="amount" id="completiontime" name="completiontime" placeholder="Bảng lương" >
                                        <div class="error-message" id="completiontimeError">Vui lòng nhập vị trí hiện tại.</div>
                                    </div>
                                    <div class="flex-container">
                                        <label for="KPIs">KPIs:</label><br>
                                        <input type="text" class="amount" id="KPIs" name="KPIs" placeholder="KPIs" >
                                        <div class="error-message" id="KPIsError">Vui lòng nhập vị trí hiện tại.</div>
                                    </div>
                                    <div class="flex-container">
            ...
            <div class="table">
                <table>
                    ...
                    <?php
                        ...
                        //caulenh
                        $lietke_sql = "SELECT * FROM `position` ORDER BY `position`.`ID` DESC";
                        //thuc thi cau lenh
                        ...
                        while($r = mysqli_fetch_assoc($result)){
                            $amount1 = $r["Sales_milestone"];
                            $formattedAmount1 = formatCurrency($amount1);
                            $amount2 = $r["completion_time"];
                            $formattedAmount2 = formatCurrency($amount2);
                            $amount3 = $r["KPIs"];
                            $formattedAmount3 = formatCurrency($amount3);
                            ?>
                                <tr>
                                    <td><?php echo $r['ID'];?></td>
                                    ...
                                    <td><?php echo $formattedAmount3;?> VNĐ</td>
                                    <td class="button">
                                        <?php if(checkPrivilege('edit_position.php?id=0')) { ?>
                                        <button class="editButton" data-id="<?php echo $r['ID']; ?>">
                                            <i class="fa-solid fa-pen-to-square icon"></i>
                                        </button>
                                        <?php } ?>
                                        <?php if(checkPrivilege('remove_position.php?id=0')) { ?>
                                        <button>
                                            <a onclick="return confirm('bạn có muốn xóa nhân sự này không');" href="remove_position.php?sid=<?php echo $r['ID']; ?>"><i class="fa-solid fa-user-minus icon"></i></a>
                                        </button>
                                        <?php } ?>
                                    </td>
                                </tr>
                ...
                <div id="Editmodal" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="modal-content-form">
                        <form action="update_position.php" method="post" id="Edit">
                                    <div class="flex-container">
                                        <input type="hidden" id="positionIdEdit" name="positionId" value="<?php echo $positionId; ?>">
                                    </div>
                                    <div class="flex-container">
                                          <label for="fullnameEdit">Chức vụ:</label><br>
                                          <input type="text" id="fullnameEdit" name="fullnameEdit" placeholder="Chức vụ" >
                                          <div class="error-message" id="fullnameEditError">Vui lòng nhập chức vụ.</div>    
                                    </div>
                                    <div class="flex-container">
                                        <label for="SalesmilestoneEdit">Cột mốc:</label><br>
                                        <input type="text" class="amount" id="SalesmilestoneEdit" name="SalesmilestoneEdit" placeholder="Cột mốc" >
                                        <div class="error-message" id="SalesmilestoneEditError">Vui lòng nhập cột mốc.</div>
                                    </div>
                                    <div class="flex-container">
                                        <label for="completiontimeEdit">Lương chấm công:</label><br>
                                        <input type="text" class="amount" id="completiontimeEdit" name="completiontimeEdit" placeholder="Lương chấm công" ><br>
                                        <div class="error-message" id="completiontimeEditError">Vui lòng nhập lương chấm công.</div>
                                    </div>
                                    <div class="flex-container">
                                        <label for="KPIsEdit">chỉ tiêu:</label><br>
                                        <input type="text" class="amount" id="KPIsEdit" name="KPIsEdit" placeholder="KPIs" ><br>
                                        <div class="error-message" id="KPIsEditError">Vui lòng nhập lương chấm công.</div>
                                    </div>
                                    <div class="flex-container">
...
<script>
    ...
    var btnDecentralization= document.getElementsByClassName("openDecentralization")
   ...
   // Lấy thông báo lỗi
    ...
    editButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            xhr.open('GET', 'edit_position.php?id=' + positionId, true);
            xhr.onload = function() {
                ...
                if (xhr.status === 200) {
                    ...
                    document.getElementById('positionIdEdit').value = data.ID;
                    document.getElementById('fullnameEdit').value = data.name;
                    document.getElementById('SalesmilestoneEdit').value = data.Sales_milestone;
                    document.getElementById('completiontimeEdit').value = data.completion_time;
                    document.getElementById('KPIsEdit').value = data.KPIs;
