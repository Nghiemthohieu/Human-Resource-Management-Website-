        ...
        <div class="display-body">
            <div class="search">
                ...
                <div class="button-add">
                    <?php if(checkPrivilege('addSoftSalarys.php')) { ?>
                        <button id="openModal">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <div class="modal-content-form">
                                <form action="add_softSalary.php" method="post" id="myForm">
            ...
            <div class="table">
                <table>
                    ...
                    <?php
                        ...
                        require_once 'conn_softSalary.php';
                        //caulenh
                        $lietke_sql = "SELECT soft_salary.ID, position.name AS position_name,soft_salary.care_part_1, soft_salary.target_1,soft_salary.care_part_2,soft_salary.target_2,soft_salary.care_part_3 FROM soft_salary INNER JOIN position ON soft_salary.ID_position = position.ID ;";
                        //thuc thi cau lenh
                        $result=mysqli_query($conn, $lietke_sql);
                        //duyet qua result và in ra
                        ...
                        while($r = mysqli_fetch_assoc($result)){
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="button">
                                        <?php if(checkPrivilege('editSoftSalarys.php?id=0')) { ?>
                                        <button class="editButton" data-id="<?php echo $r['ID']; ?>">
                                            <i class="fa-solid fa-pen-to-square icon"></i>
                                        </button>
                                        <?php } ?>
                                        <?php if(checkPrivilege('removeSoftSalarys.php?id=0')) { ?>
                                        <button>
                                            <a onclick="return confirm('bạn có muốn xóa phần này không');" href="remove_softSalary.php?sid=<?php echo $r['ID']; ?>"><i class="fa-solid fa-user-minus icon"></i></a>
                                        </button>
                                        <?php } ?>
                                    </td>
                                </tr>
                ...
                <div id="Editmodal" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="modal-content-form">
                            <form action="update_softSalary.php" method="post" id="Edit">
                                <div class="flex-container">
                                    <input type="hidden" id="softSalary_ID" name="softSalary_ID" value="">
                                </div>
                                <div class="flex-container">
                                    <label for="position">chức vụ:</label><br>
   ...
   // Lấy thông báo lỗi
    ...
    editButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            var softSalary_Id = this.getAttribute('data-id');

            // Gửi yêu cầu AJAX đến tập tin PHP xử lý
            var xhr = new XMLHttpRequest();
            xhr.open('GET', 'edit_softSalary.php?id=' + softSalary_Id, true);
            xhr.onload = function() {
                ...
                if (xhr.status === 200) {
                    ...
                    document.getElementById('softSalary_ID').value = data.ID;
