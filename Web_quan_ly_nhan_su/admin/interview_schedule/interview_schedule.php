        ...
        <div class="display-body">
            <div class="display-body-home">
                <div class="search">
                    ...
                    <div class="button-add">
                        <?php if(checkPrivilege('add_interview.php')) { ?>
                        <button id="openModal">
                        ...
                        <div id="myModal" class="modal">
                            <div class="modal-content">
                                <div class="modal-content-close">
                                    <div class="text-add">
                                        <p>Thêm Lịch phỏng vấn</p>
                                    </div>
                                    <button class="close">&times;</button>
                                </div>
                                <!-- Đây là nơi để bạn đặt form điền thông tin -->
                                <div class="modal-content-form">
                                    <form action="add_interview.php" method="post" id="myForm">
                                        <div class="flex-container">
                                            <input type="hidden" id="ID_personnal" name="ID_personnal" value="<?php echo htmlspecialchars($_SESSION['user_id']); ?>">
                                        </div>
                                        <div class="flex-container">
                                        ...
                                        <div class="flex-container">
                                            <div class="flex-item1">
                                                ...
                                                <div class="error-message" id="emailError">Vui lòng nhập năm sinh.</div>
                                            </div>
                                        </div>
                                        <div class="flex-container">
                                            <div class="flex-item1">
                                            ...
                                            <div class="flex-item2">
                                                ...
                                                <input type="text" id="yearbirth" name="yearbirth" placeholder="Năm sinh" ><br>
                                                <div class="error-message" id="yearbirthError">Vui lòng nhập năm sinh</div>
                                            </div>
                                        </div>
                                        <div class="flex-container">
                                        <div class="flex-item1">
                                            <label for="dbo">Ngày phỏng vấn:</label><br>
                                            <input type="date" id="dbo" name="dbo" ><br>
                                            <div class="error-message" id="dboError">Vui lòng chọn ngày phỏng vấn.</div>
                                        </div>
                                        <div class="flex-item2">
                                            <label for="time">Thời gian phỏng vấn: </label><br>
                                            <input type="time" id="time" name="time" ><br>
                                            <div class="error-message" id="timeError">Vui lòng chọn Thời gian phỏng vấn.</div>
                                        </div>
                                        <div class="flex-item3">
                                            <label for="form">Hình thức:</label><br>
                ...
                <div class="table" >
                    <table id="myTable">
                        <thead id="tableHead">
                            <tr>
                                ...
                                <th data-column="2">Dấu thời gian</th>
                                <th data-column="3">Họ tên</th>
                                <th data-column="4">SĐT</th>
                                <th data-column="5">Mail</th>
                                <th data-column="6">Người hỗ trợ</th>
                                <th data-column="7">Trường</th>
                                <th data-column="8">Năm sinh</th>
                                <th data-column="9">Ngày phỏng vấn</th>
                                <th data-column="10">Giờ phỏng vấn</th>
                                <th data-column="11">Hình thức</th>
                                <th data-column="12">Kết quả</th>
                                <th data-column="13">Note</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php
                            ...
                            // Đếm tổng số bản ghi
                            $total_sql = "SELECT COUNT(*) FROM `interview_schedule`";
                            $total_result = mysqli_query($conn, $total_sql);
                            $total_rows = mysqli_fetch_row($total_result)[0];
                            $total_pages = ceil($total_rows / $records_per_page);
                            //caulenh
                            $interview_sql = "SELECT interview_schedule.*,personnal.Name AS personnal_name
                            ...
                            while($r = mysqli_fetch_assoc($result)){
                                ?>
                                    <tr>
                                        ...
                                        <td data-column="2"><?php echo $r['datetime'];?></td>
                                        <td data-column="3"><?php echo $r['Name'];?></td>
                                        <td data-column="4"><?php echo $r['phonenumnar'];?></td>
                                        <td data-column="5"><?php echo $r['mail'];?></td>
                                        <td data-column="6"><?php echo $r['personnal_name'];?></td>
                                        <td data-column="7"><?php echo $r['school'];?></td>
                                        <td data-column="8"><?php echo $r['year_birth'];?></td>
                                        <td data-column="9"><?php echo $r['date_interview'];?></td>
                                        <td data-column="10"><?php echo $r['time_interview'];?></td>
                                        <td data-column="11"><?php echo $r['form'];?></td>
                                        <td data-column="12">
                                            <select onchange="updateResult(this,<?php echo $r['ID']; ?>, this.value)" class="result<?php echo $r['result']; ?>">
                                                <option value="" <?php if ($r['result'] == '') echo 'selected'; ?>>KQ</option>
                                                <option value="Pass" <?php if ($r['result'] == 'Pass') echo 'selected'; ?>>Pass</option>
                                                <option value="Fail" <?php if ($r['result'] == 'Fail') echo 'selected'; ?>>Fail</option>
                                                <option value="KTG" <?php if ($r['result'] == 'KTG') echo 'selected'; ?>>KTG</option>
                                            </select>
                                        </td>
                                        <td data-column="13"><?php echo $r['Note'];?></td>

                                        <td class="button">
                                            <!-- <?php if(checkPrivilege('information_interview.php?id=0')) { ?>
                                            <button>
                                                <i class="fa-solid fa-address-card icon" ></i>
                                            </button>
                                            <?php } ?> -->
                                            <?php if(checkPrivilege('edit_interview.php?id=0')) { ?>
                                            <button class="editButton" data-id="<?php echo $r['ID'];?>">
                                                <i class="fa-solid fa-pen-to-square icon"></i>
                                            </button>
                                            <?php } ?>
                                            <?php if(checkPrivilege('remove_interview.php?id=0')) { ?>
                                            <button>
                    ...
                    <div id="Editmodal" class="modal">
                        <div class="modal-content">
                            ...
                            <div class="modal-content-form">
                                <form action="update_interview.php" method="post" id="Edit">
                                    <div class="flex-container">
                                            <input type="hidden" id="interviewIdEdit" name="interviewId" value="<?php echo $interviewId; ?>">
                                    </div>
                                    <div class="flex-container">
                                        <div class="flex-item1">
                                    ...
                                    <div class="flex-container">
                                        <div class="flex-item1">
                                            <label for="emailEdit">Mail:</label><br>
                                            <input type="email" id="emailEdit" name="emailEdit" placeholder="Mail">
                                            <div class="error-message" id="emailEditError">Vui lòng nhập năm sinh.</div>
                                        </div>
                                    </div>
                                    <div class="flex-container">
                                        <div class="flex-item1">
                                        ...
                                        <div class="flex-item2">
                                            ...
                                            <input type="text" id="yearbirthEdit" name="yearbirthEdit" placeholder="Năm sinh" ><br>
                                            <div class="error-message" id="yearbirthEditError">Vui lòng nhập năm sinh</div>
                                        </div>
                                    </div>
                                    <div class="flex-container">
                                    <div class="flex-item1">
                                        <label for="dboEdit">Ngày phỏng vấn:</label><br>
                                        <input type="date" id="dboEdit" name="dboEdit" ><br>
                                        <div class="error-message" id="dboEditError">Vui lòng chọn ngày phỏng vấn.</div>
                                    </div>
                                    <div class="flex-item2">
                                        <label for="timeEdit">Thời gian phỏng vấn: </label><br>
                                        <input type="time" id="timeEdit" name="timeEdit" ><br>
                                        <div class="error-message" id="timeEditError">Vui lòng chọn Thời gian phỏng vấn.</div>
                                    </div>
                                    <div class="flex-item3">
                                        <label for="formEdit">Hình thức:</label><br>
                                        <select id="formEdit" name="formEdit">
                                            <option value="">Chọn hình thức</option>
                                            <option value="online">Online</option>
                                            <option value="offline">Offline</option>
                                        </select>
                                        <div class="error-message" id="formEditError">Vui lòng chọn hình thức phỏng vấn.</div>
                                    </div>
                                    </div>
                                    <div class="flex-container">
                                        <div class="flex-item1">
                ...
                <div class="pagination">
                    ...
                    if ($current_page > 1) {
                        echo "<a href='interview_schedule.php?page=1'>&laquo; First</a>";
                    }

                    // Hiển thị nút "Trang trước"
                    if ($current_page > 1) {
                        $prev_page = $current_page - 1;
                        echo "<a href='interview_schedule.php?page=$prev_page'>&lsaquo; Previous</a>";
                    }
                    ...
                    for ($i = max(1, $current_page - $range); $i <= min($total_pages, $current_page + $range); $i++) {
                        ...
                        echo "<a $active href='interview_schedule.php?page=$i'>$i</a>";
                    }

                    // Hiển thị nút "Trang kế tiếp"
                    if ($current_page < $total_pages) {
                        $next_page = $current_page + 1;
                        echo "<a href='interview_schedule.php?page=$next_page'>Next &rsaquo;</a>";
                    }

                    // Hiển thị nút "Trang cuối"
                    if ($current_page < $total_pages) {
                        echo "<a href='interview_schedule.php?page=$total_pages'>Last &raquo;</a>";
                    }
                    ?>
                </div>
                <?php } ?>
            ...
            <div class="form-setting" id="form-setting">
                <form action="" id="columnForm">
                    ...
                    <label><input type="checkbox" class="toggleColumn" data-column="2" >Dấu thời gian</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="3" checked>Họ tên</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="4" >SĐT</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="5" >Mail</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="6" checked>Người hỗ trợ</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="7" checked>Trường</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="8" checked>Năm sinh</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="9" checked>Ngày phỏng vấn</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="10" checked>Giờ phỏng vấn</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="11" checked>Hình thức</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="12" checked>Kết quả</label><br>
                    <label><input type="checkbox" class="toggleColumn" data-column="13">Note</label><br>
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    editButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            xhr.open('GET', 'edit_interview.php?id=' + interviewId, true);
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    document.getElementById('interviewIdEdit').value = data.ID;
                    document.getElementById('fullnameEdit').value = data.Name;
                    document.getElementById('phoneNumberEdit').value = data.phonenumnar;
                    document.getElementById('emailEdit').value = data.mail;
                    document.getElementById('schoolEdit').value = data.school;
                    document.getElementById('yearbirthEdit').value = data.year_birth;
                    document.getElementById('dboEdit').value = data.date_interview;
                    document.getElementById('timeEdit').value = data.time_interview;
                    document.getElementById('formEdit').value = data.form;
    ...
    // JavaScript để xử lý thay đổi kết quả
    function updateResult(selectElement, Id, result) {
            // Thay đổi lớp CSS của selectElement dựa trên kết quả
            selectElement.className = ''; // Reset class
            if (result === 'Pass') {
                selectElement.classList.add('resultPass');
            } else if (result === 'Fail') {
                selectElement.classList.add('resultFail');
            } else if (result === 'KTG') {
                selectElement.classList.add('resultKTG');
            } else {
                selectElement.classList.add('result');
            }

            // Yêu cầu AJAX để cập nhật kết quả
            const xhr = new XMLHttpRequest();
            xhr.open('POST', 'updateResult.php', true);
            xhr.setRequestHeader('Content-Type', 'application/json');
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    alert('Kết quả cập nhật thành công!');
                }
            };
            const data = JSON.stringify({ Id: Id, result: result });
            xhr.send(data);
    }
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            selects.forEach(function (select) {
                ...
                if (result === 'Pass') {
                    select.classList.add('resultPass');
                } else if (result === 'Fail') {
                    select.classList.add('resultFail');
                } else if (result === 'KTG') {
                    select.classList.add('resultKTG');
                } else {
                    select.classList.add('result');
                }
            });
        });
