        ...
        <div class="display-body">
            <div class="search">
                ...
                <div class="button-add">
                    <?php if(checkPrivilege('add_product.php')) { ?>
                    <button id="openModal">
                            ...
                            <div class="modal-content-form">
                                <form action="add_product.php" method="post" id="myForm">
                                    <div class="flex-container">
                                        <label style="padding-left: 10px ;" for="fullname">tên sản phẩm:</label><br>
                                        <input type="text" id="fullname" name="fullname" placeholder=" tên sản phẩm" >
                                        <div class="error-message" id="fullnameError">Vui lòng nhập tên sản phẩm.</div>
                                    </div>
                                    <div class="flex-container">
            ...
            <div class="table">
                <table>
                    ...
                    <?php
                        ...
                        //caulenh
                        $lietke_sql = "SELECT * FROM `product` ORDER BY `product`.`ID` DESC";
                        //thuc thi cau lenh
                        ...
                        while($r = mysqli_fetch_assoc($result)){
                            ?>
                                <tr>
                                    ...
                                    <td class="button">
                                        <?php if(checkPrivilege('edit_product.php?id=0')) { ?>
                                        <button class="editButton" data-id="<?php echo $r['ID']; ?>">
                                            <i class="fa-solid fa-pen-to-square icon"></i>
                                        </button>
                                        <?php } ?>
                                        <?php if(checkPrivilege('remove_product.php?id=0')) { ?>
                                        <button>
                                            <a onclick="return confirm('bạn có muốn xóa sản phẩm này không');" href="remove_product.php?sid=<?php echo $r['ID']; ?>"><i class="fa-solid fa-user-minus icon"></i></a>
                                        </button>
                                        <?php } ?>
                                    </td>
                                </tr>
                ...
                <div id="Editmodal" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="modal-content-form">
                        <form action="update_product.php" method="post" id="Edit">
                                    <div class="flex-container">
                                        <input type="hidden" id="productIdEdit" name="productId" value="<?php echo $productId; ?>">
                                    </div>
                                    <div class="flex-container">
                                          <label for="fullnameEdit">tên sản phẩm:</label><br>
                                          <input type="text" id="fullnameEdit" name="fullnameEdit" placeholder="tên sản phẩm" >
                                          <div class="error-message" id="fullnameEditError">Vui lòng nhập tên sản phẩm.</div>    
                                    </div>
                                    <div class="flex-container">
   ...
   // Lấy thông báo lỗi
    ...
    editButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            xhr.open('GET', 'edit_product.php?id=' + productId, true);
            xhr.onload = function() {
